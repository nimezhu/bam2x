...
def ParseArg():
    ...
    p.add_argument('-c','--compare',dest="beds",action="store",default=[],help="feature annotation files",nargs="+")
...
def Main():
    ...
    if args.output=="stdout":
        ...
        try:
            ...
            out=sys.stdout
    datas=[]
    input_handle=TableIO.parse(args.input,"oddsratiosnp")
    beds=[]
    h[args.input]=0
    ...
    for f in args.beds:
        print "reading",f
        h[f]=0
        fi=TableIO.parse(f,"oddsratiosnp")
        '''
