...
# Programmer : zhuxp
# Date: 
# Last-modified: 12-30-2012, 12:18:49 CST
VERSION="0.1"
...
def ParseArg():
    ...
    #p.add_argument('-g','--genome',dest="chromSize",type=str,help="chromosome sizes file")
    return p.parse_args()
...
def Main():
    ...
    for chr in c.keys():
        ...
        for i,x in enumerate(c[chr]):
            print >>out,i,"\t",x,"\t",float(x)/b.bin2length(i),"\t",b.bin2range(i)
