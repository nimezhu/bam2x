...
def Main():
    ...
    if args.genome is not None:
        ...
        genome=None
        print >>sys.stderr,"genome required"
        exit(0)
    ...
    for i0,i in enumerate(TableIO.parse(fin,args.format)):
        ...
        '''
        adding splicing codes in pre processing
        '''
        ...
        TODO: adding coverage splicing sites
        '''
        length=len(i)
        ...
        for j,key in enumerate(sorted_keys):
            print >>out,"No."+str(j),"\t",bitarray_to_rep(hc[key]),h[key],bitarray_to_intron_number(hc[key])
            joined_clique=False
...
def sort_by_intron_and_abundance(x,y):
