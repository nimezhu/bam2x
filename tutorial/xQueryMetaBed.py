...
# Programmer : zhuxp
# Date: 
# Last-modified: 11-12-2013, 20:39:07 EST
VERSION="0.1"
...
def ParseArg():
    ...
    p.add_argument('-a','--annotations',dest="db",type=str,help="tabix file")
    p.add_argument('-H','--header',dest="db_header",type=str,help="db header file")
...
def Main():
    ...
    a=TableIO.parse(IO.fopen(args.db_header,"r"),"simple");
    header=a.next();
    db=DBI.init(args.db,"tabix",tabix="metabed",header=header);
